...
THREE.TrackballControls = function ( object, domElement ) {
	...
	this.rotateCamera = function () {
		...
		if ( angle ) {
			...
			_rotation.multiply(quaternion);
			_rotation.normalize();

			//_eye.copy(_this.position0).applyQuaternion(_rotation);
			//_this.object.up.copy(_this.up0).applyQuaternion(_rotation);
	...
	var normalx = new THREE.Vector3();
	var normalz = new THREE.Vector3();
